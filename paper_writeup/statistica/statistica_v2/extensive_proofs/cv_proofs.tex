...
\begin{eqnarray*}
 ...
 & = & \sum_{k=1}^{\infty}\Pr\left(c\|G(x|D^{(n_{T})})\|_{L_{\psi_{2}}}\ge2^{k}\sigma\right)\left[kc_{4}\left(\frac{1+a}{a}\right)^{2}\frac{J\log n_{V}}{n_{V}}K\left(1+r\right)\log\left(\frac{\left(1+a\right)\left(1+r\right)}{a}\Delta_{\Lambda}K_{2}K\|\epsilon\|_{L_{\psi_{2}}}J+1\right)\right]\\
 & \le & \left[c_{4}\left(\frac{1+a}{a}\right)^{2}\frac{J\log n_{V}}{n_{V}}K\left(1+r\right)\log\left(\frac{\left(1+a\right)\left(1+r\right)}{a}\Delta_{\Lambda}K_{2}K\|\epsilon\|_{L_{\psi_{2}}}J+1\right)\right]\sum_{k=1}^{\infty}k\Pr\left(c\|G(x|D^{(n_{T})})\|_{L_{\psi_{2}}}\ge2^{k}\right)\\
 & \le & \left[c_{4}\left(\frac{1+a}{a}\right)^{2}\frac{J\log n_{V}}{n_{V}}K\left(1+r\right)\log\left(\frac{\left(1+a\right)\left(1+r\right)}{a}\Delta_{\Lambda}K_{2}K\|\epsilon\|_{L_{\psi_{2}}}J+1\right)\right]\tilde{h}(n_{T})
\end{eqnarray*}
