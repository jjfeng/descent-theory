...
\begin{proof}
Suppose that $\mu_{2J}(\Lambda_{ext})>0$. If this is the case, then
there exists a ball with nonzero radius $r>0$, $B_{r}\left(\left(\boldsymbol{\lambda}^{(1)},\boldsymbol{\lambda}^{(2)}\right)\right)\subseteq\Lambda_{ext}$,
s.t. $\mu_{1}\left(\mathcal{L}\left(\boldsymbol{\lambda}^{'},\boldsymbol{\lambda}^{''}\right)\cap\Lambda_{smooth}^{c}\right)>0\forall\left(\boldsymbol{\lambda}^{'},\boldsymbol{\lambda}^{''}\right)\in B_{r}\left(\left(\boldsymbol{\lambda}^{(1)},\boldsymbol{\lambda}^{(2)}\right)\right)$.
Since $\mu_{1}\left(\mathcal{L}\left(\boldsymbol{\lambda}^{(1)},\boldsymbol{\lambda}^{(2)}\right)\cap\Lambda_{smooth}^{c}\right)$
must be positive, we must have $\boldsymbol{\lambda}^{(1)}\ne\boldsymbol{\lambda}^{(2)}$.
...
have
\[
\mu_{1}\left(\mathcal{L}\left(\boldsymbol{\lambda}^{'},\boldsymbol{\lambda}^{''}\right)\cap\Lambda_{smooth}^{c}\right)>\delta/2>0\forall\left(\boldsymbol{\lambda}^{'},\boldsymbol{\lambda}^{''}\right)\in B_{r'}\left(\left(\boldsymbol{\lambda}^{(1)},\boldsymbol{\lambda}^{(2)}\right)\right).
\]


To see why this claim is true, let us define a monotonically decreasing
sequence $\left\{ r_{i}\right\} $ such that $\lim_{i\rightarrow\infty}r_{i}=0$.
...
Therefore by the definition of limits, there is some sufficiently
large $i'$ such that $r'\equiv r_{i'}$ 
\[
...
where 
\[
\boldsymbol{\lambda}_{j}^{(3)}\ge\boldsymbol{\lambda}_{j}^{(5)},\boldsymbol{\lambda}_{j}^{(4)}\ge\boldsymbol{\lambda}_{j}^{(6)}\forall j=1,..,J
\]
and $\boldsymbol{\lambda}^{(3)}\ne\boldsymbol{\lambda}^{(5)},\boldsymbol{\lambda}^{(4)}\ne\boldsymbol{\lambda}^{(6)}$.
Then compare the measure of $\Lambda_{smooth}^{c}$ to the measure
of the convex hull of $\boldsymbol{\lambda}^{(3)},\boldsymbol{\lambda}^{(4)},\boldsymbol{\lambda}^{(5)},\boldsymbol{\lambda}^{(6)}$
intersected with $\Lambda_{smooth}^{c}$: 
\[
\mu\left(\Lambda_{smooth}^{c}\right)\ge\mu\left(\cup_{\alpha\in[0,1]}\left(\mathcal{L}\left(\alpha\boldsymbol{\lambda}^{(3)}+(1-\alpha)\boldsymbol{\lambda}^{(5)},\alpha\boldsymbol{\lambda}^{(4)}+(1-\alpha)\boldsymbol{\lambda}^{(6)}\right)\cap\Lambda_{smooth}^{c}\right)\right)>0.
\]
