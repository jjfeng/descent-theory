...
The main point of the following lemma is to restate Lemma 3.4 using notation that clarifies the conditional dependencies and to introduce two new functions $h$ and $J_\delta$.
\begin{lemma}
...
\begin{theorem}
	...
	Suppose Assumption~\ref{assump:tail_margin_general}.
...
$$
as the dual of the $L_{\psi_1}$ norm is $L_{\psi_2}$ (and we applied Assumption~\ref{assump:l2_psi2}).
\end{proof}
