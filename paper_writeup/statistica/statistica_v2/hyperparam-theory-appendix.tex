...
Let $Z = (X,y)$ be a random variable with values in $\mathcal{Z}$.
In contrast to the main manuscript, the random variable $Z$ is more general.
We do not require that $y - E[y | X=x]$ to be independent of $X$.
...
\textbf{Example~\ref{ex:elastic_net_tv}} (Multiple elastic nets, training-validation split)
