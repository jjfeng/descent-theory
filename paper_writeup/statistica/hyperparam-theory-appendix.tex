...
\begin{proof}
	We first check that the two assumptions in \eqref{eq:cv_assump} hold. This is easy to show with the assumption that $\sup_{g \in \mathcal G} \|g\|_\infty, \|\epsilon\|_\infty \le G$.
