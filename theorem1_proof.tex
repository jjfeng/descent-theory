...
model under general entropy conditions for fixed training data.
...
\item We extend Theorem 3 to make a statement on the convergence of the
selected model to the best model where the training data are also
random variables.
\end{enumerate}
...
Then there is some constant $a>0$ (only dependent on the characteristics
of the sub-gassian errors) such that for all $\delta>r$ with
\[
\sqrt{n_{V}}\delta^{2}\ge a\left(\psi_{T}\left(\delta\right)\vee\delta\vee\psi_{T}\left(4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)\vee4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)
\]


we have
\begin{eqnarray*}
Pr\left(\left.\left\Vert \hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}-\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}\ge\delta^{2}\wedge\|\epsilon\|_{V}\le2\sigma\right|\|\epsilon\|_{T}\le2\sigma\right) & \le & c\exp\left(-\frac{n_{V}\delta^{4}}{c^{2}\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}}\right)+c\exp\left(-\frac{n_{V}\delta^{2}}{c^{2}}\right)
\end{eqnarray*}
...
\[
\sqrt{n_{V}}\delta^{2}\ge a\left(\psi_{T}(4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V})\vee4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)
\]


we can bound the first probability using Vandegeer Corollary 8.3 as
follows
...
for all $s=0,1,2,...$ 
\begin{eqnarray*}
\sqrt{n_{V}}2^{2s+2}\delta^{2} & \ge & a\left(\psi_{T}\left(2^{s+1}\delta\right)\vee\delta\right)
\end{eqnarray*}
...
\begin{eqnarray*}
\sqrt{n_{V}}\delta^{2} & \ge & a\left(\psi_{T}\left(\delta\right)\vee\delta\right)
\end{eqnarray*}
...
\[
\sqrt{n_{V}}\delta^{2}\ge a\left(\psi_{T}\left(\delta\right)\vee\delta\vee\tilde{\psi_{T}}\left(4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)\vee4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)
\]
...
Then for any $\delta>n_{V}^{-1}\wedge n_{T}^{-1}$ such that

\[
\delta^{2}\ge\frac{\alpha^{2}}{n_{V}}\vee\alpha\frac{1}{\sqrt{n_{V}}}\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}
\]


where 
\[
\alpha=a\left[\left[\log\frac{1}{C_{J}}+J(1+\log4+\log8C)+J\log\left(\lambda_{max}-\lambda_{min}\right)+J\log\left(n_{V}\vee n_{T}\right)\right]^{1/2}\right]\vee1
\]
...
\begin{eqnarray*}
Pr\left(\left\Vert \hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}-\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}\ge\delta\wedge\|\epsilon\|_{V}\le2\sigma\wedge\|\epsilon\|_{T}\le2\sigma\right) & \le & c\exp\left(-\frac{n_{V}\delta^{4}}{c^{2}\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}}\right)+c\exp\left(-\frac{n_{V}\delta^{2}}{c^{2}}\right)
\end{eqnarray*}
...
for all $R\ge n_{V}^{-1}\wedge n_{T}^{-1}$

\[
\int_{0}^{R}H{}^{1/2}(u,\mathcal{G}(T),\|\cdot\|_{V})du\le\psi_{T}(R)=R\left[\log\frac{1}{C_{J}}+J(1+\log4+\log8C)+J\log\left(\lambda_{max}-\lambda_{min}\right)+J\log\left(n_{V}\vee n_{T}\right)\right]^{1/2}
\]


Notice we've replaced the last term $\log\frac{1}{R}$ with $\log\left(n_{V}\vee n_{T}\right)$,
...
Now we apply Theorem 3 to the choice of $\delta>n_{V}^{-1}\wedge n_{T}^{-1}$
that satisfies
\[
\sqrt{n_{V}}\delta^{2}\ge a\left(\psi_{T}\left(\delta\right)\vee\delta\vee\psi_{T}\left(4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)\vee4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)
\]
...
\[
\psi_{T}\left(\delta\right)\vee\delta\ge\psi_{T}\left(4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)\vee4\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}
\]
...
\[
\delta^{2}\ge\frac{4}{\sqrt{n_{V}}}\left\Vert \hat{g}\left(\cdot|\tilde{\boldsymbol{\lambda}}\right)-g^{*}\right\Vert _{V}\alpha
\]


Putting these two inequalities together, we find that $\delta>n_{V}^{-1}\wedge n_{T}^{-1}$
must satisfy
\[
\delta^{2}\ge\frac{\alpha^{2}}{n_{V}}\vee\alpha\frac{1}{\sqrt{n_{V}}}\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}
\]
...
\begin{eqnarray*}
\left\Vert \hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2} & \le & \left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}+O_{p}\left(\frac{1+J(\kappa+t_{max})\log n_{T}+J\log n_{V}}{n_{V}}\right)+O_{P}\left(\left[\frac{1+J(\kappa+t_{max})\log n_{T}+J\log n_{V}}{n_{V}}\right]^{1/2}\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}\right)
\end{eqnarray*}
...
Furthermore, suppose we know that with high probability, for any training
dataset, there is an oracle penalty parameter vector $\tilde{\boldsymbol{\lambda}}$
such that the optimal convergence rate $O_{p}\left(n_{T}^{-2\omega}\right)$
. That is, suppose there are constants $W,\omega>0$ only dependent
on the model class $\mathcal{G}$ such that 
\[
...
Now we can extend \textbf{Theorem 3} further.
...
Let 
\[
K=\sup_{\lambda\in\Lambda}\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|_{\infty}
\]
...
Then for all $\delta>n_{V}^{-1}\wedge n_{T}^{-1}$ such that 
\[
\sqrt{n_{V}}\delta^{2}\ge\alpha\left(\psi_{T}(\delta)\vee\delta\vee\psi_{T}(\tilde{\delta}_{t})\vee\tilde{\delta}_{t}\right)
\]


we have
\[
Pr\left(\left\Vert \hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}-\left[\min_{\lambda\in\Lambda}\left\Vert \hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\right\Vert _{V}^{2}\right]\ge\delta^{2}\right)\le c\exp\left(-\frac{n_{V}\delta^{4}}{c^{2}\tilde{\delta}_{t}}\right)+c\exp\left(-\frac{n_{V}\delta^{2}}{c^{2}}\right)+\exp(-t_{1})+p(n_{T})+\exp(-t)+c\exp\left(-\frac{n_{T}\sigma^{2}}{c^{2}}\right)+c\exp\left(-\frac{n_{V}\sigma^{2}}{c^{2}}\right)
\]
...
\begin{eqnarray*}
 ...
 & \le & Pr\left(\left\Vert \hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}-\left[\min_{\lambda\in\Lambda}\left\Vert \hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\right\Vert _{V}^{2}\right]\ge\delta^{2}\wedge\|\epsilon\|_{V}\le2\sigma\wedge\|\epsilon\|_{T}\le2\sigma\wedge\min_{\lambda\in\Lambda}\left\Vert \hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\right\Vert _{V}^{2}\le\tilde{\delta}^{2}\right)\\
 &  & +Pr\left(\min_{\lambda\in\Lambda}\left\Vert \hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\right\Vert _{V}^{2}\ge\tilde{\delta}_{t}^{2}\right)\\
 &  & +Pr\left(\|\epsilon\|_{T}\ge2\sigma\right)\\
 &  & +Pr\left(\|\epsilon\|_{V}\ge2\sigma\right)
\end{eqnarray*}
...
\begin{eqnarray*}
Pr\left(\left\Vert \hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}-\left[\min_{\lambda\in\Lambda}\left\Vert \hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\right\Vert _{V}^{2}\right]\ge\delta^{2}\wedge\|\epsilon\|_{V}\le2\sigma\wedge\|\epsilon\|_{T}\le2\sigma\wedge\min_{\lambda\in\Lambda}\left\Vert \hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\right\Vert _{V}^{2}\le\tilde{\delta}^{2}\right) & \le & c\exp\left(-\frac{n_{V}\delta^{4}}{c^{2}\tilde{\delta}_{t}}\right)+c\exp\left(-\frac{n_{V}\delta^{2}}{c^{2}}\right)
\end{eqnarray*}
...
Finally, we bound the last two terms using Bernstein's inequality
since $\epsilon$ are independent sub-gaussian random variables
\[
Pr\left(\|\epsilon\|_{V}^{2}\ge4\sigma^{2}\right)\le c\left(-\frac{n_{V}\sigma^{2}}{c^{2}}\right)
\]


and
\[
Pr\left(\|\epsilon\|_{T}^{2}\ge4\sigma^{2}\right)\le c\left(-\frac{n_{T}\sigma^{2}}{c^{2}}\right)
\]
...
\begin{eqnarray*}
\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2} & = & \|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}-\left(\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|_{V}^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|_{V}^{2}\right)\\
 &  & +\left(\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|_{V}^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|_{V}^{2}\right)\\
 & \le & \left|\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|_{V}^{2}\right|+\left|\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|_{V}^{2}\right|
\end{eqnarray*}


For the first inequality, note that by definition, we have 
\[
\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|_{V}^{2}\le\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|_{V}^{2}
\]


Using Theorem 2.1, we have that for all $\delta_{n},t>0$ such that

\[
\delta_{n}\ge\frac{2J_{\infty}\left(K_{\Lambda},\mathcal{G}\right)+K_{\Lambda}\sqrt{t}}{\sqrt{n_{T}}}+\frac{4J_{\infty}^{2}(K_{\Lambda},\mathcal{G})+K_{\Lambda}^{2}t}{n_{T}}
\]


we have
\[
Pr\left(\sup_{\lambda\in\Lambda}\left|\frac{\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|^{2}-\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|_{V}^{2}}{\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|^{2}}\right|\le\delta_{n}\right)\ge1-\exp(-t)
\]


Under the condition that $\sup_{\lambda}\left|\frac{\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|^{2}-\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|_{V}^{2}}{\|\hat{g}(\cdot|\boldsymbol{\lambda})-g^{*}\|^{2}}\right|\le\delta_{n}$,
we have
\begin{eqnarray*}
\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2} & \le & \delta_{n}\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}+\delta_{n}\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}\\
 & = & \delta_{n}\left(\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}\right)+2\delta_{n}\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}
\end{eqnarray*}


So we have that
\begin{eqnarray*}
Pr\left(\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}\le\frac{2\delta_{n}}{1-\delta_{n}}\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}\right) & \ge & 1-\exp(-t)
\end{eqnarray*}


If we can choose $\delta_{n}\le1/2$, then
\begin{eqnarray*}
Pr\left(\|\hat{g}(\cdot|\hat{\boldsymbol{\lambda}})-g^{*}\|^{2}-\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}\le4\delta_{n}\|\hat{g}(\cdot|\tilde{\boldsymbol{\lambda}}_{gen})-g^{*}\|^{2}\right) & \ge & 1-\exp(-t)
\end{eqnarray*}
