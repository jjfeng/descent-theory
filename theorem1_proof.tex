...
\[
Pr_{V}\left(\left.\frac{1}{C_{1}}\left|\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert _{V}^{2}-\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert ^{2}\right|\le\left\Vert \hat{g}(\cdot|\tilde{\boldsymbol{\lambda}})-g^{*}\right\Vert K\sqrt{\frac{t}{n_{V}}}+\frac{K^{2}t}{n_{V}}\right|T\right)\le1-\exp(-t)
\]
