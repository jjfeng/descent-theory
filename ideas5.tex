...
\begin{eqnarray*}
 ...
 & \le & \frac{1}{2}\|y-\hat{g}_{\lambda}(\cdot|D)\|_{D}^{2}+t\langle y-\hat{g}_{\lambda}(\cdot|D),\hat{g}_{\lambda}(\cdot|D)-\xi\rangle_{D}+t^{2}\|\xi-\hat{g}_{\lambda}\|_{D}^{2}+\lambda\left(tP^{v}(\xi)+(1-t)P^{v}\left(\hat{g}_{\lambda}(\cdot|D)\right)+t\frac{w}{2}\|\xi\|^{2}+(1-t)\frac{w}{2}\|\hat{g}_{\lambda}(\cdot|D)\|^{2}\right)\\
 & \le & \frac{1}{2}\|y-\hat{g}_{\lambda}(\cdot|D)\|_{D}^{2}+t\langle y-\hat{g}_{\lambda}(\cdot|D),\hat{g}_{\lambda}(\cdot|D)-\xi\rangle_{D}+\frac{t^{2}}{2}\|\xi-\hat{g}_{\lambda}\|_{D}^{2}+\lambda\left(tP^{v}(\xi)+(1-t)P^{v}\left(\hat{g}_{\lambda}(\cdot|D)\right)+t\frac{w}{2}\|\xi\|^{2}+(1-t)\|\hat{g}_{\lambda}(\cdot|D)\|^{2}\right)
\end{eqnarray*}
