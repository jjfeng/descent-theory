...
\[
\|\hat{g}_{\hat{\lambda}}-g^{*}\|_{V}=O_{p}(n^{-1/(2+\alpha+\xi)})\left(M^{\alpha/v(2+\alpha)}\|g^{*}\|_{2n}^{\alpha/2v(2+\alpha)}\vee I(g^{*})\right)
\]


Hence the convergence rate is infinitely close to the optimal convergence
rate $O_{p}(n^{-1/(2+\alpha)})$ attained by $\tilde{\lambda}$, but
it doesn't actually attain it.
...
By Lemma 2, we have 
\[
\left|\|g^{*}-\hat{g}_{\tilde{\lambda}}\|_{T}-\|g^{*}-\hat{g}_{\tilde{\lambda}}\|_{V}\right|\le O_{p}(n^{-1/(2+\alpha+\xi)})\left(I(\hat{g}_{\tilde{\lambda}})+I(g^{*})\right)
\]


Therefore, for any $\xi>0$, we have
\begin{eqnarray*}
\|g^{*}-\hat{g}_{\hat{\lambda}}\|_{V} & \le & O_{p}(1)\|g^{*}-\hat{g}_{\tilde{\lambda}}\|_{V}\\
 & \le & O_{p}(1)\|g^{*}-\hat{g}_{\tilde{\lambda}}\|_{T}+O_{p}(n^{-1/(2+\alpha+\xi)})I(g^{*})
\end{eqnarray*}
