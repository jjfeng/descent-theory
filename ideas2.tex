...
the reproducing Hilbert kernel space, we have 
\[
\|g_{\lambda}\|_{n}^{2}=\Omega\alpha,\mbox{ }I_{(k)}^{2}(g_{\lambda})=\alpha^{T}\Omega\alpha
\]


Then suppose $\|\Omega\alpha\|=O_{p}(n^{\tau})\|\alpha\|_{2}^{2}$
for some constant $\tau$. Then
\begin{eqnarray*}
