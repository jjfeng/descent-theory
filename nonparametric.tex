...
\[
\|\hat{g}_{j}(\cdot|\boldsymbol{\lambda}^{(2)})-\hat{g}_{j}(\cdot|\boldsymbol{\lambda}^{(1)})\|_{D}\le\frac{1}{w\lambda_{min}^{2}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\left\Vert \boldsymbol{\lambda}^{(2)}-\boldsymbol{\lambda}^{(1)}\right\Vert 
\]
...
\begin{eqnarray*}
\left|\frac{\partial}{\partial m_{k}}P_{k}(\hat{g}_{1,k}+m_{k}h_{k})+w\langle h_{k},\hat{g}_{1,k}+m_{k}h_{k}\rangle_{D}\right|_{m=\hat{m}(\lambda)} & = & \left|\frac{1}{\lambda_{k}}\left\langle y-\sum_{j=1}^{J}\left(\hat{g}_{1,j}+\hat{m}_{j}(\boldsymbol{\lambda})h_{j}\right),h_{k}\right\rangle _{T}\right|\\
 ...
 & \le & \frac{1}{\lambda_{min}}\left\Vert y-\sum_{j=1}^{J}\left(\hat{g}_{1,j}+\hat{m}_{j}(\boldsymbol{\lambda})h_{j}\right)\right\Vert _{T}\left(\sqrt{\frac{n_{D}}{n_{T}}}\|h_{k}\|_{D}\right)
\end{eqnarray*}
...
\begin{eqnarray*}
 &  & \frac{1}{2}\left\Vert y-\sum_{j=1}^{J}\left(\hat{g}_{1,j}+\hat{m}_{j}(\boldsymbol{\lambda})h_{j}\right)\right\Vert _{T}^{2}+\sum_{j=1}^{J}\lambda_{j}\left(P_{j}(\hat{g}_{1,j})+\frac{w}{2}\left\Vert \hat{g}_{1,j}+\hat{m}_{j}(\boldsymbol{\lambda})h_{j}\right\Vert _{D}^{2}\right)\\
 & \le & \frac{1}{2}\left\Vert y-\sum_{j=1}^{J}\hat{g}_{1,j}\right\Vert _{T}^{2}+\sum_{j=1}^{J}\lambda_{j}\left(P_{j}(\hat{g}_{1,j})+\frac{w}{2}\|\hat{g}_{1,j}\|_{D}^{2}\right)\\
...
So 
\begin{eqnarray*}
\left|\frac{\partial}{\partial m_{k}}P_{k}(\hat{g}_{1,k}+m_{k}h_{k})+w\langle h_{k},\hat{g}_{1,k}+\hat{m}_{k}(\boldsymbol{\lambda})h_{k}\rangle_{D}\right|_{m=\hat{m}(\lambda)} & \le & \frac{1}{\lambda_{min}}\sqrt{2C\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\left(\sqrt{\frac{n_{D}}{n_{T}}}\|h_{k}\|_{D}\right)
\end{eqnarray*}
...
of $D_{3}$
\[
D_{3,upper}=\frac{1}{\lambda_{min}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}diag\left(\|h_{k}\|_{D}\right)
\]
...
\|\nabla_{\lambda}\hat{m}_{k}(\lambda)\| & = & \|Me_{k}\|\\
 ...
 & \le & \frac{1}{\lambda_{min}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\max_{\ell=1:J}\|h_{\ell}\|_{D}\left\Vert \left(S+D_{1}+D_{2}\right)^{-1}e_{k}\right\Vert \\
 & \le & \frac{1}{\lambda_{min}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\max_{\ell=1:J}\|h_{\ell}\|_{D}\left\Vert D_{2}^{-1}e_{k}\right\Vert 
\end{eqnarray*}
...
\begin{eqnarray*}
\|\nabla_{\lambda}\hat{m}_{\ell_{max}}(\lambda)\| & \le & \frac{1}{\lambda_{min}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\|h_{\ell_{max}}\|_{D}\left\Vert D_{2}^{-1}e_{k}\right\Vert \\
 & = & \frac{1}{\lambda_{min}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\|h_{\ell_{max}}\|_{D}\lambda_{\ell_{max}}^{-1}w^{-1}\|h_{\ell_{max}}\|_{D}^{-2}\\
 & \le & \frac{1}{w\lambda_{min}^{2}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\|h_{\ell_{max}}\|_{D}^{-1}
\end{eqnarray*}
...
\left|\hat{m}_{\ell_{max}}(\boldsymbol{\lambda}^{(2)})-\hat{m}_{\ell_{max}}(\boldsymbol{\lambda}^{(1)})\right| & = & \left|\left\langle \boldsymbol{\lambda}^{(2)}-\boldsymbol{\lambda}^{(1)},\nabla_{\lambda}\hat{m}_{\ell_{max}}(\boldsymbol{\lambda})\right\rangle _{\boldsymbol{\lambda}=\alpha\boldsymbol{\lambda}^{(1)}+(1-\alpha)\boldsymbol{\lambda}^{(2)}}\right|\\
 & \le & \left\Vert \boldsymbol{\lambda}^{(2)}-\boldsymbol{\lambda}^{(1)}\right\Vert \frac{1}{w\lambda_{min}^{2}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\|h_{\ell_{max}}\|_{D}^{-1}
\end{eqnarray*}
...
\[
\max_{j}\|\hat{g}_{j}(\cdot|\boldsymbol{\lambda}^{(2)})-\hat{g}_{j}(\cdot|\boldsymbol{\lambda}^{(1)})\|_{D}=\|h_{\ell_{max}}\|_{D}\le\frac{1}{w\lambda_{min}^{2}}\sqrt{2C\frac{n_{D}}{n_{T}}\left(1+\frac{J\lambda_{max}}{\lambda_{min}}\right)}\left\Vert \boldsymbol{\lambda}^{(2)}-\boldsymbol{\lambda}^{(1)}\right\Vert 
\]
