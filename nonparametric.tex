...
it out. Depending on the situation, we get smoothness of the form
\end{enumerate}

\[
\|\hat{g}\left(\cdot|\boldsymbol{\lambda}^{(2)}\right)-\hat{g}\left(\cdot|\boldsymbol{\lambda}^{(1)}\right)\|_{D}^{2}\le C\|\boldsymbol{\lambda^{(2)}}-\boldsymbol{\lambda^{(1)}}\|_{2}
\]
or
\[
\|\hat{g}\left(\cdot|\boldsymbol{\lambda}^{(2)}\right)-\hat{g}\left(\cdot|\boldsymbol{\lambda}^{(1)}\right)\|_{D}\le C\|\boldsymbol{\lambda^{(2)}}-\boldsymbol{\lambda^{(1)}}\|_{2}
