...
\[
E\left[\|g^{*}-\hat{g}_{MCV}(\cdot|D)\|^{2}\right]\le(1+a)E\left[\|g^{*}-\hat{g}_{D^{(n_{T})}}(\cdot|\boldsymbol{\lambda})\|^{2}\right]+(1+a)\frac{cJ}{n_{V}}\left(\frac{(1+a)}{a}\left(C_{\Lambda}+\frac{1}{2}\log n_{V}\right)+4GC_{\Lambda}\left(\log n_{V}\right)\right)
\]
...
Finally, we get
\begin{eqnarray*}
E\left[\|g^{*}-\hat{g}_{MCV}(\cdot|D)\|^{2}\right] & \le & (1+a)E\left[\|g^{*}-\hat{g}_{D^{(n_{T})}}(\cdot|\boldsymbol{\lambda})\|^{2}\right]+ac\left(\frac{K_{n,1}^{2}}{4}q^{5}\left(\frac{2(1+a)}{a\sqrt{n_{V}}}\right)^{2}+K_{n,2}\frac{1}{\sqrt{n_{V}}}\left(\frac{2q^{2}(1+a)}{a\sqrt{n_{V}}}\right)\right)\\
 & = & (1+a)E\left[\|g^{*}-\hat{g}_{D^{(n_{T})}}(\cdot|\boldsymbol{\lambda})\|^{2}\right]+\frac{c}{n_{V}}\left(K_{n,1}^{2}q^{5}\frac{(1+a)^{2}}{a}+2K_{n,2}q^{2}(1+a)\right)
\end{eqnarray*}
...
Then for all $a>0$,
\[
E\left[\|g^{*}-\hat{g}_{MCV}(\cdot|D)\|^{2}\right]\le(1+a)\min_{\lambda\in\Lambda}E_{D^{(n_{T})}}\left[\|g^{*}-\hat{g}_{D^{(n_{T})}}(\cdot|\boldsymbol{\lambda})\|^{2}\right]+c_{a}\frac{J}{n_{V}}c_{1}\left(\left(t_{max}+\kappa\right)\log(n_{T})+\log G+c_{2}\right)\left(\log n_{V}+c_{3}\right)
\]


where $c_{1},c_{2},c_{a}$ are constants.
